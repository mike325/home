...
def Settings(**kwargs):
    ...
    logger.info('Settings function Called')

    language = kwargs['language']
    filename = kwargs['filename']
    client_data = None if 'client_data' not in kwargs else kwargs['client_data']

    logger.info('File: {0}; Language: {1}'.format(filename, language))
...
def FlagsForFile(filename, **kwargs):
    ...
    """
    logger.info('FlagsForFile function Called')
    settings = kwargs
